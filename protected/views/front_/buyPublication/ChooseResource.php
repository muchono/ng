					...
					<div class="main clearfix">
                        ...
                        <?php $form=$this->beginWidget('CActiveForm', array(
							...
							<ul class="anchors_filter">
								...
								<li>
									...
									<label for="brand_name_url">Brand Name or URL</label></li>
							</ul>
							<hr>
						...
						<div class="output">
							<div class="caption-block">
								<h1 class="left">All Resources</h1>
                            ...
                            <ul class="goods-list">
                            <?php $this->renderPartial('_products', array('products'=>$products, 'pager'=>$pager)); ?>
                            </ul>
                            <div class="loader" id="loader_bottom" style="display: none">
								<img src="img/content/loader.gif" alt=""> <!-- Must be GIF animate -->
								<h5>Loading...</h5>
							</div>
						</div>
					</div>
