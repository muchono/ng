					...
					<div class="main clearfix">
						<div class="caption-block">
							...
							<div class="search">
								<div class="input-line right-butt">
									...
									<span id="faq_search_but"><img src="img/content/search-ic.png" alt=""></span>
								</div>
							</div>
                            </form>
						</div>
						...
						<div class="right-side">
							<ul class="list-menu">
                                ...
                                <li class="<?php echo (!empty($_GET['cid']) && $_GET['cid'] == $c->id ? 'active' : ''); ?>"><a href="<?php echo $this->createUrl('faq/', array('cid' => $c->id)); ?>"><?php echo $c->title; ?> <span>(<?php echo $c->categoryCount; ?>)</span></a></li>
                                <?php }?>
							</ul>
						</div>
					</div>
