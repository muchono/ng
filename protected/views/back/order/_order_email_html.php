											...
											<tbody>
												...
												<tr>
													<td style="padding-top:20px;padding-bottom:20px;padding-right:40px;padding-left:40px;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:20px;color:#333;border-collapse:collapse">
														<p>
Hello <?php echo $order->user->name?>,<br/>
<br/>
Thanks for using Netgeron,<br/>
<br/>
Your order (Invoice #: <?php echo $order->id?>)  is completely done.<br/>
You can check links to ready publications your section Live Report:<br/>
<a href="<?php echo Yii::app()->getBaseUrl(true) . '/buyPublication/LiveReport'?>"><?php echo Yii::app()->getBaseUrl(true) . '/buyPublication/LiveReport'?></a><br/>
<br/>
Note: You got this message because you've ordered writing and placing publications on Netegron.<br/>
<br/>
--<br/>
Best Regards,<br/>
