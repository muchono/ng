...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'time_interval'); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'payment_method',array('size'=>2,'maxlength'=>2)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'payment_status'); ?>
		<?php echo $form->textField($model,'payment_status',array('size'=>2,'maxlength'=>2)); ?>
	</div>
