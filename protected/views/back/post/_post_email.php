				...
				<tr>
					<td style="padding-top:20px;padding-bottom:20px;padding-right:0;padding-left:0;text-align:left;border-collapse:collapse" valign="middle">
						<a href="#" style="display:inline-block;color:#3686be" target="_blank">
							<img src="<?php echo Yii::app()->getBaseUrl(true);?>/img/email/logo.png" alt="image" height="34" width="182" border="0" class="CToWUd"></a>
					</td>
					<td style="padding-top:20px;padding-bottom:20px;padding-right:0;padding-left:0;text-align:right;font-family:Helvetica,Arial,sans-serif;font-size:12px;border-collapse:collapse" valign="middle">
                        <a href="<?php echo $this->createFrontUrl($model->url_anckor); ?>" style="font-size:14px;color:#616161;text-decoration:none;" target="_blank">View in browser</a>
					</td>
				</tr>
				<tr>
											...
											<tbody>
												<tr>
													<td style="padding-top:20px;padding-bottom:0;padding-right:40px;padding-left:40px;font-family:sans-serif;font-size:20px;line-height:27px;border-collapse:collapse">
                                                        <h3 style="font-weight:bold;font-size:30px;color:#333333;line-height:36px;margin-top:27px;margin-bottom:35px;"><?php echo $model->title; ?></h3>
													</td>
												</tr>
												...
												<tr>
													<td style="padding-top:0;padding-bottom:0;padding-right:40px;padding-left:40px;font-family:sans-serif;font-size:20px;line-height:27px;border-collapse:collapse">
														<a href="<?php echo $this->createFrontUrl($model->url_anckor); ?>" style="color:#3686be" target="_blank">
                                                            <img src="<?php echo Yii::app()->getBaseUrl(true) . "/" . $model->getImageName('email');?>" alt="image" style="max-width:100%;min-height:auto;margin-top:auto;margin-bottom:auto;margin-right:auto;margin-left:auto;display:block" align="middle" border="0" class="CToWUd"></a>
													</td>
												</tr>
												...
												<tr>
													<td style="padding-top:20px;padding-bottom:20px;padding-right:40px;padding-left:40px;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:20px;color:#333;border-collapse:collapse">
                                                        <?php echo $model->getBrief(); ?>
														<a href="<?php echo $this->createFrontUrl($model->url_anckor); ?>" style="background-color:#49a13c;color:#fff;border-radius:4px;font-size:24px;display:block;text-decoration:none;margin-top:40px;margin-bottom:15px;margin-right:auto;margin-left:auto;padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;text-align:center;width:325px;text-transform:uppercase;text-decoration:none;" target="_blank">Read The Blog Post</a>
													</td>
												</tr>
											</tbody>
										</table>
