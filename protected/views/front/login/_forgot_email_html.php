...
<br/>
Your password reset link is: <a href="<?php echo $url?>"><?php echo $url?></a><br/>
<br/>
If you did not make this request to reset your password, simply ignore this message.<br/>
The link will automatically expire in 72 hours.<br/>
<br/>
--<br/>
Best Regards,<br/>
