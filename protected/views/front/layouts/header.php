			<header>
				<div class="container">
					<div class="logo">
						<a href="/">
							<img src="<?php echo Yii::app()->request->baseUrl; ?>/img/content/logo.png" alt="netgeron">
						</a>
					</div>
					<?php if (Yii::app()->user->isGuest){?>
					<nav class="main-nav">
						<ul>
                            <li <?php echo $this->page == 'home' ? 'class="active"' : ''?>><a href="/">Home</a></li>
							<li <?php echo $this->page == 'hit' ? 'class="active"' : ''?>><a href="<?php echo $this->createUrl('/howitworks');?>">How it works</a></li>
							<li <?php echo $this->page == 'about' ? 'class="active"' : ''?>><a href="<?php echo $this->createUrl('/about');?>">About</a></li>
							<li <?php echo in_array($this->page, array('blog','blog post')) ? 'class="active"' : ''?>><a href="<?php echo $this->createUrl('blog/');?>">Blog</a></li>
							<li <?php echo $this->page == 'for_writers' ? 'class="active"' : ''?>><a href="<?php echo $this->createUrl('/forwriters');?>">For Writers and Website Owners</a></li>
						</ul>
					</nav>
					...
					<div class="control-pane">
                        ...
                        <div class="cart <?php echo $cart->count ? '' : 'empty'?>">
                            <a href="<?php echo $this->createUrl('buyPublication/SubmitDetails');?>">
								<span>
									<img src="<?php echo Yii::app()->request->baseUrl; ?>/img/content/cart-ic.png" alt="">
								</span>
