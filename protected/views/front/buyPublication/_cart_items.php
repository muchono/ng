										...
										<table>
											<tr>
												<td class="one">
													<a href="">
														<div class="goods-img">
															<img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo Product::IMG_DIR . $citem->product->image?>" alt="">
														</div>
													</a>
												</td>
												<td class="two">
													<h2><span class="black-cl">The Post on</span> <?php echo $citem->product->title?></h2>
													<table>
														<tr>
															<td class="one">
													...
													<table class="comment">
														<tr>
															...
															<td class="comment-area">
                                                                ...
                                                                <?php echo $form->error($citem,'comment'); ?>
															</td>
														</tr>
													</table>
												</td>
