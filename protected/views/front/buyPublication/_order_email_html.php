...
<br/>
This is a payment receipt for Invoice <?php echo $order->id; ?> sent on <?php echo date('m/d/Y', $order->timeInt()); ?><br/>
<br/>
Amount: $<?php echo $order->total; ?> USD<br/>
Invoice #: <?php echo $order->id; ?><br/>
Total Paid: $<?php echo $order->total; ?> USD<br/>
Status: Paid<br/>
<br/>
